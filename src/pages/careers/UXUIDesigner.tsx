...
import { ChevronRightIcon, PenToolIcon, CheckIcon, TrendingUpIcon, BookOpenIcon, BriefcaseIcon } from 'lucide-react';
import Header from '../../components/Header';
import Footer from '../../components/Footer';
import { Link } from 'react-router-dom';
const UXUIDesigner = () => {
  const skills = ['User research and usability testing', 'Wireframing and prototyping', 'Visual design principles', 'Information architecture', 'Design tools (Figma, Adobe XD, Sketch)', 'Interaction design', 'Responsive design', 'Design systems and component libraries'];
  const courses = [{
    ...
    description: 'Learn to create intuitive mobile app interfaces, understand platform guidelines, and design engaging user experiences for iOS and Android.',
    duration: '6 Weeks',
    link: '/courses'
  }];
  const jobRoles = ['UX Designer', 'UI Designer', 'Product Designer', 'Interaction Designer', 'UX Researcher', 'Visual Designer', 'Design System Specialist'];
      ...
      <main className="flex-grow">
        ...
        <section className="relative bg-primary text-white py-20">
          <div className="absolute inset-0 overflow-hidden">
            <img src="https://images.unsplash.com/photo-1561070791-2526d30994b5?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1000&q=80" alt="UI/UX design background" className="w-full h-full object-cover opacity-20" />
          </div>
              ...
              <div className="md:w-1/2 mb-8 md:mb-0">
                ...
                duration: 0.5
                  ...
                  <div className="inline-block p-2 bg-accent/20 rounded-lg mb-4">
                    <PenToolIcon size={40} className="text-accent" />
                  </div>
                  <h1 className="text-4xl md:text-5xl font-bold mb-6">
                    UX/UI Designer Career Path
                  </h1>
                  <p className="text-xl mb-8 max-w-lg">
                    Create intuitive and engaging digital experiences. Develop
                ...
                delay: 0.2
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start">
                      ...
                      <p>
                        Increasing demand as Pakistani businesses focus on
                    ...
                    <li className="flex items-start">
                      <div className="mr-2 mt-1 text-green-400">•</div>
                      <p>
                        Average starting salary: Rs. 50,000 - 80,000 per month
                      </p>
                    </li>
                    <li className="flex items-start">
                      <div className="mr-2 mt-1 text-green-400">•</div>
                      <p>
                        Experienced designers: Rs. 120,000 - 300,000+ per month
                      </p>
                    </li>
                    <li className="flex items-start">
                      <div className="mr-2 mt-1 text-green-400">•</div>
                      <p>
                        Opportunities in tech companies, design agencies, and
                        freelance work
                      </p>
                    </li>
                  </ul>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Master these in-demand skills to become a successful UX/UI
                designer in Pakistan's digital landscape
              </p>
            </div>
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                UX/UI design offers diverse career paths with opportunities to
        ...
        <section id="courses" className="py-16 bg-white">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Start your UX/UI design journey with our industry-aligned
                courses
              </p>
            </div>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-gray-200 max-w-2xl mx-auto">
                  Follow these steps to begin your journey as a UX/UI designer
                  in Pakistan
                </p>
              </div>
              <div className="space-y-6">
                ...
                description: 'Learn the basics of visual design, color theory, typography, and user experience principles.'
              }, {
                step: '2',
                title: 'Master design tools',
                description: 'Enroll in our UI/UX Design Essentials course to learn Figma and other industry-standard tools.'
              }, {
                step: '3',
                title: 'Build your design portfolio',
                description: 'Create redesigns, concept projects, and real-world solutions to showcase your skills.'
              }, {
                step: '4',
                title: 'Learn basic front-end development',
                description: 'Understanding HTML, CSS, and basic JavaScript will make you a more effective designer.'
              }, {
                step: '5',
                title: 'Network and find opportunities',
                description: 'Connect with other designers, join design communities, and apply for internships or entry-level positions.'
